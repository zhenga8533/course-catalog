...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference("Recommendation.count") do
      post recommendations_url, params: { recommendation: { prof_email: @recommendation.prof_email, section_id: @recommendation.section_id, student_email: @recommendation.student_email } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { prof_email: @recommendation.prof_email, section_id: @recommendation.section_id, student_email: @recommendation.student_email } }
